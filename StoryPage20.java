...
public class StoryPage20 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage20(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\all police.jpg");
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage21 sp21 = new StoryPage21();
		window.dispose();
	}
}
