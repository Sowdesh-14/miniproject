...
public class StoryPage19 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage19(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\fight-2.png");
		...
		text = "You escaped and the opponent starts firing";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage20 sp20 = new StoryPage20();
		window.dispose();
	}
}
