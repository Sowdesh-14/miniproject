...
public class StoryPage21 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage21(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\police thanking.jpg");
		...
		text = "POLICE: Thanks Mr.Detective!!";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage22 sp22 = new StoryPage22();
		window.dispose();
	}
}
