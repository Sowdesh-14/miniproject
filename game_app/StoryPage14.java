...
public class StoryPage14 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage14(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\locker.jpg");
		...
		text = "(Directly to locker !?.. This explains everything)";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage15 sp15 = new StoryPage15();
		window.dispose();
	}
}
