...
public class StoryPage11 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage11(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\wierd guy.jpg");
		...
		text = "YOU : (This must be his apartment)\r\n" + 
				"What do you know about this?\r\n" + 
				"\r\n" + 
				"Wierd Guy: It belongs to one of the thieves who wiped the bank.All newbies, so I helped them out. This guy resides right behind the bank!\r\n" + 
				"Just leave me!!\r\n" + 
				"\r\n" + 
				"YOU: (Handed him to the police)";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage12 sp12 = new StoryPage12();
		window.dispose();
	}
}
