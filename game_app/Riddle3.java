...
public class Riddle3 extends JFrame implements ActionListener{
	...
	Riddle3()
	{
		...
		setTitle("Riddle3 Page");
		
		pgtitle = new JLabel("Riddle 3", JLabel.CENTER);
		...
		qn = new JLabel("What can't you name without breaking it?");
		...
		txt_t3 = new TextField();
		txt_t3.setBounds(350, 200, 200, 30);
		add(txt_t3);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(a3.length()==0 || a3==null)
		  ...
		  try {
			...
			String str3 = "";
			if((str3=br.readLine())!=null)
			{
				String ss3[] = str3.split("%");
				if(a3.equals(ss3[1]) || a3.equals(ss3[2]) || a3.equals(ss3[3]))
				{
