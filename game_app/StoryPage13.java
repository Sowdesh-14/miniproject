...
public class StoryPage13 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage13(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\underground passag.jpg");
		...
		text = "( A secret underground passage ! )";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage14 sp14 = new StoryPage14();
		window.dispose();
	}
}
