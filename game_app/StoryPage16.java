...
public class StoryPage16 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage16(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\fight.jpg");
		...
		text = "(Over hear a guy talking about the money )\r\n" + 
				"Fight scene\r\n" + 
				"YOU: What's the plan? Where you're shifting the money?\r\n" + 
				"\r\n" + 
				"THIEF: Harbour\r\n" + 
				"\r\n" + 
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage17 sp17 = new StoryPage17();
		window.dispose();
	}
}
