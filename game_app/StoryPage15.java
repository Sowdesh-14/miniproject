...
public class StoryPage15 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage15(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\police informed.jpg");
		...
		text = "It's the same car\r\n" + 
				"(Returning in the same path)";
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage16 sp16 = new StoryPage16();
		window.dispose();
	}
}
