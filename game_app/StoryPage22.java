...
public class StoryPage22 extends JFrame implements ActionListener{
	JFrame window;
    JPanel textPanel;
    JTextArea textArea;
    JButton jbtn_next;
    ...
    public StoryPage22(){
		...
		ImageIcon img = new ImageIcon("C:\\Users\\Mohana Sowdesh\\Desktop\\Mini project\\solved.jpg");
    ...
    @Override
    public void actionPerformed(ActionEvent e) {
    	StoryPage23 sp23 = new StoryPage23();
		window.dispose();
	}
}
